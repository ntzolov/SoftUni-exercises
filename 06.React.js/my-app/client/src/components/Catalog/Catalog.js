export const Catalog = () => {
  return (
    <div className="card-container">
      <div className="card">
        <div className="image">
          <img src="https://lastfm.freetls.fastly.net/i/u/ar0/911447ab0bfb842e66b22c7cd2ce524f.jpg" alt="" />
        </div>
      ...
      <div className="card">
        <div className="image">
          <img src="https://variety.com/wp-content/uploads/2013/03/ironman31.jpg?w=1000&h=563&crop=1" alt="" />
        </div>
        <div className="content">
          <h1>Ironman</h1>
          <p className="title">
