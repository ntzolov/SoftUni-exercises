...
-- 'Cocktail' AS type,
-- CEILING(salary * 0.01) AS price FROM waiters
-- WHERE id > 6;
-- 
-- UPDATE orders
...
-- SELECT p.id, p.name, count(*) AS count FROM products p
-- JOIN orders_products op ON op.product_id = p.id
-- GROUP BY op.product_id
-- HAVING `count` >= 5
-- ORDER BY `count` DESC, p.name;

-- SELECT t.id AS table_id, t.capacity AS capacity, count(oc.client_id) AS count_clients,
-- CASE
